...
unipept_out_path = './unipept_output_data/CPTAC_unipept_taxon.csv'
...
out_df = acast(z, taxonomy ~ sample, value.var = 'intensity', drop = F, fun.aggregate = mean)
...
ggsave('./normalization_plots/taxon/CPTAC_taxonomy_boxplot_before_norm.png',p1_1,dpi=600,width = 10, height = 5)
ggsave('./normalization_plots/taxon/CPTAC_taxonomy_density_before_norm.png',p1_2,dpi=600,width = 10, height = 5)
...
ggsave('./normalization_plots/taxon/CPTAC_taxonomy_boxplot_IRS.png',p2_1,dpi=600,width = 10, height = 5)
ggsave('./normalization_plots/taxon/CPTAC_taxonomy_density_IRS.png',p2_2,dpi=600,width = 10, height = 5)
...
ggsave('./normalization_plots/taxon/CPTAC_taxonomy_boxplot_IRS_SL.png',p3_1,dpi=600,width = 10, height = 5)
ggsave('./normalization_plots/taxon/CPTAC_taxonomy_density_IRS_SL.png',p3_2,dpi=600,width = 10, height = 5)
...
write.table(
  write_frame,
  './output_taxon_abundance_data/CPTAC.taxon_abundance.irs_sl.NAfiltered.txt.noheader',
  col.names = F,
  sep = '\t',
  quote = F
)
...
write.table(
  out_df_header,
  './output_taxon_abundance_data/CPTAC.taxon_abundance.irs_sl.NAfiltered.txt.header',
  col.names = F,
  sep = '\t',
  quote = F
)
