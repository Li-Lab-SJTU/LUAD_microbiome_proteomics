...
unipept_out_path = './unipept_output_data/TW_unipept_go.tsv'
...
ggsave('./normalization_plots/go/TW_go_boxplot_before_norm.png',p1_1,dpi=600,width = 10, height = 5)
ggsave('./normalization_plots/go/TW_go_density_before_norm.png',p1_2,dpi=600,width = 10, height = 5)
...
sum(ir_sample==0,na.rm=T) ## there are some ref-channels that were 0
...
ggsave('./normalization_plots/go/TW_go_boxplot_IRS.png',p2_1,dpi=600,width = 10, height = 5)
ggsave('./normalization_plots/go/TW_go_density_IRS.png',p2_2,dpi=600,width = 10, height = 5)
...
ggsave('./normalization_plots/go/TW_go_boxplot_IRS_SL.png',p3_1,dpi=600,width = 10, height = 5)
ggsave('./normalization_plots/go/TW_go_density_IRS_SL.png',p3_2,dpi=600,width = 10, height = 5)
...
write.table(
  write_frame,
  './output_go_abundance_data/TW.go_abundance.irs_sl.NAfiltered.txt.noheader',
  col.names = F,
  sep = '\t',
  quote = F
)
...
write.table(
  out_df_header,
  './output_go_abundance_data/TW.go_abundance.irs_sl.NAfiltered.txt.header',
  col.names = F,
  sep = '\t',
  quote = F
)